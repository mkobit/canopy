...
Ensure perf-sensitive code is never rewritten blind.
Any module designated perf-based must carry a perf/load test, and the set of such modules plus their benchmark status is tracked in a maintained inventory so gaps are visible and filed as beads.
