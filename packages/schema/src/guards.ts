import type { ScalarValue, PropertyValue, Node, Edge } from '@canopy/types';
...
// Instant is number at runtime
export function isInstantValue(value: ScalarValue): value is number {
  return typeof value === 'number';
}
