...
const ScalarValueSchema: z.ZodType<ScalarValue, z.ZodTypeDef, unknown> = z.discriminatedUnion(
  'kind',
  [
    TextValueSchema,
    NumberValueSchema,
...
// Property Value
export const PropertyValueSchema: z.ZodType<PropertyValue, z.ZodTypeDef, unknown> =
...
export const PropertyDefinitionSchema: z.ZodType<PropertyDefinition, z.ZodTypeDef, unknown> = z
  .object({
    name: z.string(),
    valueKind: z.enum([
      'text',
...
export const NodeTypeDefinitionSchema: z.ZodType<NodeTypeDefinition, z.ZodTypeDef, unknown> = z
  .object({
    id: TypeIdSchema,
    name: z.string(),
    description: z.string().optional(),
...
export const EdgeTypeDefinitionSchema: z.ZodType<EdgeTypeDefinition, z.ZodTypeDef, unknown> = z
  .object({
    id: TypeIdSchema,
    name: z.string(),
    description: z.string().optional(),
